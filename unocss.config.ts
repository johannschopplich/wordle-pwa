...
export default defineConfig({
  ...
  shortcuts: {
    ...
    button: `${control} inline-flex items-center justify-center border-transparent bg-amber-600 text-white font-medium hover:bg-amber-700 focus:ring-2 focus:ring-offset-2 focus:ring-amber-600 disabled:cursor-default disabled:bg-gray-100 disabled:text-gray-500 disabled:border-gray-100 dark:focus:ring-offset-gray-900`,
