  ...
  <div class="space-y-2">
    ...
    >
      ...
      <button
        ...
        :key="keyIndex"
        :class="[
          'button h-12 p-0 bg-gray-200 text-gray-900 text-base font-600 uppercase select-none transition-color,background-color-200 transition-delay-1500 hover:bg-gray-200',
